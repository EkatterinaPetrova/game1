...
m_games = Menu("Игры", buttons=["Игра КНБ", "Игра КНБ-MP", "Игра в 21", "Крокодил", "Выход"], module="botGames", parent=m_main)
...
m_DZ = Menu("ДЗ", buttons=["Задание-1,2", "Задание-3", "Задание-4,5", "Задание-6", "Задание-7", "Задание-8","Выход"], parent=m_main, module="DZ")
m_fun = Menu("Развлечения", buttons=["Прислать собаку", "Прислать лису", "Прислать анекдот", "Прислать фильм", "Выход","Прислать погоду","Прислать предсказание"], parent=m_main, module="fun")
m_voice = Menu("Голос!", buttons=["Текущее время", "Выход"], parent=m_main, module="speech")
Menu.loadCurMenu()
